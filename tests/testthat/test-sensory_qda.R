...
test_that("sensory_qda rejects duplicated data column names", {
...
test_that("sensory_qda rejects whitespace-only data column names", {
...
test_that("sensory_qda rejects missing data column names", {
...
test_that("sensory_qda rejects non-character design column names", {
...
test_that("sensory_qda rejects non-finite pca_components", {
